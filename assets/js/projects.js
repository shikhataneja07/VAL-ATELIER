...
window.PROJECTS = [
  ...
  },
  {
    ...
    category: "Retail",
    status: "finished",
    typology: "Pet Store and Grooming",
    location: "",
    area: "",
    scope: "Interior Design",
  ...
  },
  {
    ...
    story: ["Powder blue accents, bespoke wall art, tactile fabrics, and sculptural forms create a sophisticated sense of whimsy. Thoughtfully designed furniture and curated decor bring warmth and personality while maintaining a calm, uncluttered aesthetic. The result is an elegant, dreamlike space that feels youthful, elevated, and timeless.","This children's bedroom is designed as a soft, whimsical retreat with a refined contemporary character. Sculptural furniture, rounded detailing, and charming custom elements bring a sense of personality while keeping the space clean and sophisticated. Thoughtfully integrated storage and delicate styling complete a dreamy, intimate room that feels youthful, elegant, and effortlessly chic.","Warm timber finishes, soft pastel accents, and whimsical forms create an inviting and playful atmosphere. The immersive wildlife mural adds depth and storytelling, while integrated shelving and activity zones keep the space functional and organised. Gentle lighting and organic curves soften the interior, creating a nurturing environment for creativity, exploration, and everyday learning."],
    notes: ["Sky","Teddy","Play Room"],
